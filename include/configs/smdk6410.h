...
#define virt_to_phys(x) virt_to_phys_smdk6410(x)
...
#define CONFIG_SYS_PROMPT		"Linx_ARM # "	/* Monitor Command Prompt     */
 ...
 *				"bootm 0xc0018000"
 */
#define CONFIG_BOOTCOMMAND	"nand read 0xc50018000 0x100000 0x500000;" \
				"bootm 0xc50018000"
#else
